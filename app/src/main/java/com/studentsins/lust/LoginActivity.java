...
public class LoginActivity extends AppCompatActivity {
    ...
    /**
     * Represents an asynchronous login used to authenticate
     * the user.
     */
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                myJson.put("email",mEmail);
                myJson.put("password",mPassword);

                String response = post("https://api.studentsins.com/v1/auth", myJson.toString());
